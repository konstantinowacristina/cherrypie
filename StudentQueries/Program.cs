...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(OwnContext context)
		{
		...
		static void FilterAndOrder(OwnContext context)
		{
		...
		static void Join(OwnContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(OwnContext context)
		{
			var result = from s in context.Students
		...
		{
			using (OwnContext c = new OwnContext())
			{
